    ...
    '@graph': [
      {
        ...
        description: 'Türkiye genelinde hasarlı, kazalı, pert ve hurda araç alımı yapan güvenilir firma.',
        url: baseUrl,
      ...
      },
      {
        ...
        url: baseUrl,
        name: process.env.NEXT_PUBLIC_SITE_NAME,
        description: 'Hasarlı araç alımında Ankara\'nın güvenilir adresi',
        publisher: {
          '@id': `${baseUrl}#business`,
        },
        potentialAction: {
