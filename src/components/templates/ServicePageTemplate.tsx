...
import { FaCar, FaClipboardCheck, FaFileAlt, FaExchangeAlt, FaCarCrash, FaTools, FaExclamationTriangle, FaRecycle } from 'react-icons/fa';
                                ...
                                <div className="bg-gradient-to-br from-lacivert-700 to-lacivert-500 rounded-2xl p-6 text-white shadow-xl">
                                    ...
                                    <div className="space-y-3">
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-whatsapp-500 hover:bg-whatsapp-600 text-white font-bold rounded-xl transition-all"
                                        >
                                            <span>💬</span>
                                            <span>WhatsApp</span>
                                        </a>
