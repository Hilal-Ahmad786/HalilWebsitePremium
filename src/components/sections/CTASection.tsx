...
export default function CTASection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-800 via-lacivert-500 to-gray-800 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-turuncu-500 rounded-full blur-3xl animate-pulse" />
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-lacivert-500 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-lacivert-500/20 rounded-2xl backdrop-blur-sm -rotate-12" />
