      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Binlerce memnun müşterimizin bizimle ilgili düşünceleri.
          </p>
        </div>
          ...
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-full bg-turuncu-500/20 flex items-center justify-center text-turuncu-500 font-bold">
