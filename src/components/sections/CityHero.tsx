        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="inline-flex items-center gap-3 px-6 py-4 bg-turuncu-500/20 backdrop-blur-sm border border-turuncu-500/30 rounded-xl">
              ...
              <div>
                <div className="font-bold text-lg">{highlight}</div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-3xl font-bold text-turuncu-400 mb-1">{stats.responseTime}</div>
                  <div className="text-xs text-blue-200">Yanıt Süresi</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-3xl font-bold text-turuncu-400 mb-1">{stats.satisfaction}</div>
                  <div className="text-xs text-blue-200">Memnuniyet</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center">
                  <div className="text-3xl font-bold text-turuncu-400 mb-1">{stats.experience}</div>
