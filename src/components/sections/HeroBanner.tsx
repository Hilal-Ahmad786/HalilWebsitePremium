...
export default function HeroBanner({ 
  ...
  const variantConfig = {
    default: { icon: '🚗', gradient: 'from-lacivert-800 via-lacivert-700 to-lacivert-800' },
    kazali: { icon: '💥', gradient: 'from-red-800 via-red-700 to-red-800' },
    hasarli: { icon: '🔧', gradient: 'from-purple-800 via-purple-700 to-purple-800' },
    pert: { icon: '📋', gradient: 'from-blue-800 via-blue-700 to-blue-800' },
    hurda: { icon: '♻️', gradient: 'from-green-800 via-green-700 to-green-800' },
  };
